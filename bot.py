...
import threading
import psutil
token = "MTA4MTUyMzc0MDMzODI5MDcyOQ.GcpGFD.RC4BIeT1svyu9F0l00TnnxI-LydHg6d_tIKGJ0"
buyers = [847455634068996096]
admins = [847455634068996096]
ownerList = [847455634068996096]
